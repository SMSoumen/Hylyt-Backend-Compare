...
<script>
	...
	$(document).ready(function(){
	    ...
	    appuserListTable = $('#notifications-table').DataTable({
	        ...
	        columns: [
	            { data: '0', name: 'notification_text' },
	            { data: '1', name: 'notif_image', sortable: false, searchable: false },
	            { data: '2', name: 'sent_on', searchable: false },
	            { data: '3', name: 'sent_by', sortable: false, searchable: false },
