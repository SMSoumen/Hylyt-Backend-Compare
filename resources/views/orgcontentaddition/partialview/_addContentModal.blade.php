...
@php
	...
	$contTitle = "";
   	...
   	{
		$addContId = $id;//$addContentDetails->mlm_content_addition_id;
		$contTitle = $addContentDetails->content_title;
    ...
    if(isset($addContentDetails->filename))
    {
    	$contImageFileName = $addContentDetails->filename;
	}
@endphp
		...
		<div class="modal-content">
			...
			<div class="modal-body" id="divAddContent">
				...
				<div class="row">
					...
					<div class="col-md-12 form-group tt">
						{!! Form::label('content_title', 'Content Title *', ['class' => 'control-label']) !!}
						{{ Form::textArea('content_title', $contTitle, ['class' => 'form-control', 'id' => 'content_title', 'autocomplete' => 'off', 'rows'=>'1', $disabledInput]) }}
					</div>
