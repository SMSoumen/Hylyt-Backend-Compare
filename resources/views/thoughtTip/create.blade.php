...
<div class="row">
	<div class="col-md-12">
		...
		<div class="box box-primary">
            ...
            <div class="box-body">
			    {!! Form::open(['url' => route('thoughtTip.store'), 'class' => 'form-horizontal', 'id' => 'frmAddThoughtTip']) !!}
		            <div class="form-group {{ $errors->has('for_date') ? 'has-error' : ''}}">
		                ...
		                <div class="col-sm-6 sandbox-container">
                			{!! Form::text('for_date', null, ['class' => 'form-control', 'autocomplete' => 'off', 'id' => 'for_date']) !!}
		            ...
		            <div class="form-group {{ $errors->has('thought_tip_text') ? 'has-error' : ''}}">
		                ...
		                <div class="col-sm-6">
							{!! Form::textArea('thought_tip_text', null, ['class' => 'form-control', 'autocomplete' => 'off', 'rows' => '3']) !!}
