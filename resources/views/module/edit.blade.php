...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                    {!! Form::open(['url' => route('module.update'), 'class' => 'form-horizontal', 'id' => 'frmEditModule']) !!}
                        <div class="form-group {{ $errors->has('module_name') ? 'has-error' : ''}}">
                            {!! Form::label('module_name', 'Module Name', ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-6">
                                {!! Form::text('module_name', $module->module_name, ['class' => 'form-control', 'autocomplete' => 'off']) !!}
                                {!! $errors->first('module_name', '<p class="help-block">:message</p>') !!}
                            </div>
                        </div>

                        {!! Form::hidden('moduleId', $module->module_id) !!}
