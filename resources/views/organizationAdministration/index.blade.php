			...
			"columnDefs": [
	        	{
	                ...
	                "render": function ( data, type, row )
	                {
						...
						var credButtonHtml = '&nbsp;&nbsp;<button type="button" onclick="resendOrganizationAdminCred('+id+');" class="btn btn-xs btn-purple"><i class="fa fa-envelope"></i>&nbsp;&nbsp;Credentials</button>';
						
						return statusButtonHtml+credButtonHtml;
