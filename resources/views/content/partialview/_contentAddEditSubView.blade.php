					...
					@if(!$contentIsRemoved && $isContentPartRepliableByUser && $contentFolderTypeId == 0)
						<div class="row">	
							...
							<div class="col-md-12" style="padding-left: 40px; padding-right: 40px;">
								...
								<!--<div>-->
								<!--    <small>(<span id="chatWordCount">0</span>/100) word limit is 100.</small>-->
								<!--</div>-->
							</div>
						</div>
					@endif
			...
			<div class="row">	
				<div class="col-md-12" style="padding-left: 40px; padding-right: 40px;">
					<div class="form-group">
						<input maxlength="100" class="form-control" type="text" value="{{$editContentTitle}}" name="content_title" placeholder="Note Title">
					</div>
