...
<script>
	...
	$(document).ready(function(){
	    ...
	    couponCodeTableObj = $('#coupon-code-table').DataTable({
	        ...
	        serverSide: true,
	         ajax: {
	            url: "{!!  route('premiumCouponCodeDatatable') !!}",
	            method: 'POST',
	            data: function ( d ) {
	                d.usrToken = "{{ $usrtoken }}";
	                d.couponId = "{{ $couponId }}";
	        ...
	        columns: [
	            ...
	            { data: '1', name: 'coupon_srno' },
	            { data: '2', name: 'utilization', searchable: false, sortable: false },
	            { data: '3', name: 'utilized_at' },
	            { data: '4', name: 'utilized_by_name', searchable: false, sortable: false },
	        ],
	        "order": [[ 3, "desc" ]],
        	dom: 'Bfrtip',
		    iDisplayLength: -1,
		...
		<div class="box box-primary">
            ...
            <div class="box-body">
            	...
            	<div class="row">
			        <div class="col-md-3">
			            <div class="form-group">
			                {!! Form::label('couponMultiUsageCount', 'Usage Count', ['class' => 'control-label']) !!}
		                	<br/>
							{{ $couponMultiUsageCount }}         
			            </div>
			        </div>
			        <div class="col-md-9">
			            <div class="form-group">
