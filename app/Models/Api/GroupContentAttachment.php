...
class GroupContentAttachment extends Model
{
    /**
     ...
     * @var string
     */
    public $table = 'group_content_attachments';
    public $contentTable = 'group_contents';
    ...
    */
     ...
     */
    protected $fillable = [
        'group_content_id', 'filename', 'server_filename', 'attachment_id', 'filesize', 'is_modified', 'att_cloud_storage_type_id', 'cloud_file_url', 'cloud_file_id', 'create_ts', 'update_ts', 'cloud_file_thumb_str'
    ];
    ...
    public function scopeOfGroupContentAndId($query, $userContentId, $attachmentId)
    {
        return $query->where('group_content_id', $userContentId)->where('attachment_id', $attachmentId);
    }

    public function scopeOfGroupContent($query, $grpContentId)
    {
        return $query->where('group_content_id', $grpContentId);
    }

    public function scopeByAttachmentId($query, $attId)
    {
        return $query->where('content_attachment_id', $attId);
    }
