...
class GroupContent extends Model
{
    ...
    */
     ...
     */
    protected $fillable = [
        'group_id', 'content_type_id', 'content', 'content_title', 'from_date', 'from_time', 'from_timestamp', 'to_date', 'to_time', 'to_timestamp', 'create_date', 'create_time', 'create_timestamp', 'update_timestamp', 'is_marked', 'created_by', 'shared_by_email', 'color_code', 'is_locked', 'is_share_enabled', 'remind_before_millis', 'repeat_duration', 'is_completed', 'is_snoozed', 'reminder_timestamp', 'created_by_member_id', 'sync_with_cloud_calendar_google', 'sync_with_cloud_calendar_onedrive', 'created_at', 'updated_at'
    ];
