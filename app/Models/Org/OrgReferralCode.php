...
class OrgReferralCode extends Model
{
    /**
     ...
     * @var string
     */
    public $table = 'organization_referral_codes';
    ...
    */
     ...
     */
    protected $fillable = [
    	'referral_code', 'user_count', 'allotted_days', 'allotted_quota_in_gb', 'expiration_date', 'created_by', 'updated_by'
    ];
