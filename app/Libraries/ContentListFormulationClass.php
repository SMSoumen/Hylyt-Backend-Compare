...
class ContentListFormulationClass 
{
    ...
    public function formulateContentObject($depMgmtObj, $isFolder, $content, $searchStr, $hasFilters, $filShowAttachment = -1, $filAttachmentExtArr)
    {
        ...
        if(isset($content))
        {
            ...
            if($searchStr != "") {
                if (!$addContent && (strpos(strtolower($strippedContentText), $searchStr) !== false  || strpos(strtolower($contentTitle), $searchStr) !== false))
                {
                    $addContent = TRUE;
            ...
            {           
                ...
                if($searchStr != "") {
                    ...
                    if (strpos(strtolower($contentTitle), $searchStr) !== false) {
                        $contentTitle = $this->searchAndHighlightText($searchStr, $contentTitle);
                    }
                ...
                $contentObj['contentTitle'] = ($contentTitle); // rawurlencode
