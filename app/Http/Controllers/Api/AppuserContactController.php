...
{	
	                	...
	                	if(isset($contObj->id))
	                	{
		                    ...
		                    if(isset($userContent))
			                {
			                	...
			                	if($contentText != "")
			                	{
			                		...
			                		if(count($appUsers) > 0)
			                		{
			        					$addedFolderContentResponseArr = $this->addUserContent($appUsers, $userContent, $contentIsLocked, $inpIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserName, $sharedByUserEmail, $userId, $userSession);
									...
									if(count($groups) > 0)
			                		{
				        				$addedGroupContentResponseArr = $this->addGroupContent($groups, $memberIdArr, $finalShareGroupIdArr, $userContent, $contentIsLocked, $inpIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserName, $sharedByUserEmail, $userSession);
    ...
    public function addUserContent($appUsers, $mainContent, $contentIsLocked, $contentIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserName, $sharedByUserEmail, $sharedByUserId, $userSession)
    {
		...
		foreach($appUsers as $appUser)
		{
            ...
            $addedFolderContentId = $depMgmtObj->createSentFolderContent($mainContent, $contentIsLocked, $contentIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserEmail, $sharedByUserId);
    ...
    public function addGroupContent($groups, $memberIdArr, $appuserIdArr, $mainContent, $contentIsLocked, $contentIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserName, $sharedByUserEmail, $userSession)
    {
		...
		foreach($groups as $i => $group)
		{
            ...
            $addedGroupContentId = $depMgmtObj->createSentGroupContent($groupId, $memberId, $mainContent, $contentIsLocked, $contentIsShareEnabled, $contentText, $contentAttachmentsArr, $sharedByUserName, $sharedByUserEmail);
