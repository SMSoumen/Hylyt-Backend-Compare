            ...
            if(isset($user) )
            {
                ...
                if(isset($contentArr) && count($contentArr)>0)
                {
                    ...
                    for($i=0; $i<count($contentArr); $i++)
                    {
		            	...
		            	$contentResponse = $depMgmtObj->addEditContent($serId, $content, $contentType, $folderId, $sourceId, $tagsArr, $isMarked, $createTimeStamp, $updateTimeStamp, $fromTimeStamp, $toTimeStamp, $colorCode, $contentIsLocked, $contentIsShareEnabled, $remindBeforeMillis, $repeatDuration, $isCompleted, $isSnoozed, $reminderTimestamp, array(), "", $syncWithCloudCalendarGoogle, $syncWithCloudCalendarOnedrive, $contentIsRemoved, $contentRemovedAt);
