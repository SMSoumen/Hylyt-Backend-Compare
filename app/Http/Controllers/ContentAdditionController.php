...
class ContentAdditionController extends Controller
{
    ...
    {      
        ...
        $contAdditions = MlmContentAddition::select(['mlm_content_addition_id', 'content_title', 'content_text', \DB::raw("DATE_FORMAT(sent_at, '$dateTimeFormat') as sent_on"), "employee_name as sent_by"]); 
    ...
    public function addAppuserContent()
    {
        ...
        $contentTitle = Input::get('content_title');
        ...
        {    
        	$status = 1;
            $conAddResp = $this->saveAddContentDetails($addContentId, $contentTitle, $contentText, $contentFile, $fileChanged);   
        ...
        {
        	$status = -1;
			$msg = "Content Title and Text Is Required";
		}
    ...
    {    	
        ...
        if($addContentId != "" && $addContentId > 0)
        {
        	...
        	if(isset($addContDetails))
        	{
        		...
        		$contentTitle = $addContDetails->content_title;
				...
				$isTest = 0;
				$this->addAndSendContent($appUsers, $isTest, $contentText, $contentTitle, $contentFileName, $contentFileUrl, $addContentId);	
    ...
    function addAndSendContent($appUsers, $isTest, $contentText, $contentTitle, $contentFileName, $contentFileUrl, $addContentId)
    {
		foreach($appUsers as $appUser)
		{
			...
			if(isset($userConst))
			{
                ...
                $response = $depMgmtObj->addEditContent(0, $contentText, $contentTitle, $contentType, $defFolderId, $sourceId, $tagsArr, $isMarked, $createTimeStamp, $updateTimeStamp, $fromTimeStamp, $toTimeStamp, $colorCode, $isLocked, $isShareEnabled, $remindBeforeMillis, $repeatDuration, $isCompleted, $isSnoozed, $reminderTimestamp, $removeAttachmentIdArr); 
    ...
    function saveAddContentDetails($addContentId, $addContentTitle, $addContentText, $addContentFile, $fileChanged)
    {
    	$contArr = array();
    	$contentFileName = "";
    	...
    	$addContentDetails['content_title'] = $addContentTitle;
